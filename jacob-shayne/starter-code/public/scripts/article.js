...
// TODO:DONEish? Wrap the contents of this file, except for the preceding 'use strict' and 'var app...' declararions, in an IIFE.
...
(function(module){
  ...
  Article.loadAll = rows => {
    ...
    // TODO:notDONE Refactor this forEach code, by using a `.map` call instead, since what we are trying to accomplish
    ...
    app.Article.all = Article.map(function(ele) {
